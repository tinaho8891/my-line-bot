...
【關鍵字】濕包裹 / 破損包裹 / 破掉 / 濕掉 / 重複件 取消件 遺失件 / 無法驗收 / 異常包裹
【標準答案】
異常包裹|濕/破損包裹:
1. 直接回報 AppSheet
2. 需拍 : 面單照、濕/破損位置照
...
1. PDA 進入 AppSheet,點【FBS每日寄件箱回報】,檢查門市所有區域,找出當下所有 FBS 環保無包裝包裹(AppSheet 欄位數量僅供參考,以當天實際門市數量為主)

2. 將 FBS 環保無包裝包裹相疊,放在 WH 離店擺放區;FBS 需南、北分落,並擺上 FBS 南北標示文宣

3. AppSheet 上傳照片及南北數量,拍照回報群組,請於 21:00 前完成(以證明擺放位置正確,避免司機收錯)

【關鍵字】FBS 離店裝箱 / 環保無包裝 逐顆裝箱
【標準答案】
FBS(無包裝隔日到)離店裝箱流程:
1. 以 TO 單辨別是否為無包裝隔日到(FBS)包裹(賣家 TO 單有「無包裝隔日到(FBS)」字樣及南/北標示)

2.根據包裹類型分開執行打包作業:
- 大紙箱 FBS 寄件:以「裸箱」方式離店
- 破壞袋或小包裝 FBS 寄件:集中裝入「黑箱」離店

3. 物流系統點【環保無包裝逐顆裝箱】

4. 物流箱類型選【逐顆裝箱】
5. 逐顆刷包裹;【南】、【北】分開刷裝(不可裝在同一個物流箱中)
6. 印出物流箱單(TO 單)並貼上:
-破壞袋或小包裝包裹:裝入黑色物流箱 → 裝完後刷入物流箱 RFID → 門市物流箱單(TO)貼在物流箱【左上角】
-大紙箱包裹:刷完包裹條碼後 → 點【完成】→ 系統印出門市物流箱單(TO 單),貼在箱上的賣家物流箱單旁(請勿覆蓋)

7. 將無包裝隔日到(FBS)包裹疊放在門市指定位置;擺放時依物流箱單上的南北標示分開疊放,並在最上方貼上 FBS 南、北標示
...
【標準答案】
關於 **HD（重型貨物/大型宅配）** 的相關資訊，請參考以下說明：

## 📦 HD 打包流程 & 時間表

請參考此圖文說明：
🔗 [HD 流程 / 時間表 / SCSHD 打包 / HD 上架](https://drive.google.com/file/d/16zG3_pmASdtIwGMhVMffNtq_zkHFanb3/view?usp=drive_link)

## ⚠️ HD 錯誤 / HD 櫃異常處理

請參考此圖文說明：
🔗 [HD 錯誤 / HD 一般宅配 / HD 清空 / HD 櫃異常](https://drive.google.com/file/d/18O7IzS44POYki8g5xOl1mHh7hlVg5Pce/view?usp=drive_link)
...
【關鍵字】SCS 異常 / FBS 異常 / RTS / SCS
【標準答案】
SCS、FBS 異常件處理
(無需等待 RTS,可直接送回 WH;重點:有什麼貼什麼)
（皆不需使用夾鏈袋裝）
...
---
⚠️ 若還是無法登入：
- 到後場『登出平板再登入』，即可看到帳號密碼 ✅
---
若以上步驟操作後仍無法登入，請聯繫區經理協助處理 🙌
