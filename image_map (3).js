...
const IMAGE_MAP = [
  ...
  // ---------- AMS 資產管理 / 報修(需排在掃描槍、標籤機條目之前)----------
  {
    ...
    images: [
      IMG('1s8XJ_tv47yG0jgjC3Yf370RT-6osGxUa'), // IMG_7757 維修申請流程
      IMG('1VLpCnJNu14bN0a3KUnze5OWZ7K93E4vw'), // IMG_7758
      IMG('1ihXbrr7E4TpG2vNA3cg1lWx1Abjmx8Qo'), // IMG_7759
    ],
  },
  ...
  },
  {
    ...
    images: [
      IMG('1VQGXVTCABByshNng5xFDcMxCxsZnTsfu'), // SCS異常1 異常件事項總覽
      IMG('1UKq--UDarww2G6YdOkzbjHf-4l653d-p'), // SCS異常2 異常定義與判斷
      IMG('1kKZCBGOQ4_oQI7QErWE_-qJRIh1PTSc5'), // SCS異常3 裝箱步驟1-3
      IMG('1AzUw1KilHl7w6zTTTyrAHCgwWjxUsU3i'), // SCS異常4 裝箱步驟4-5(TO單貼法)
    ],
  },
  {
    keywords: /夾鏈袋|裸裝.*(太大|裝不)|裝不進.*(袋)/,
    images: [IMG('1iYgj3Qs2xA8d_Fzzbqi-ZTY38nHaW5Kf')], // SCS異常5 Q&A藍色厚垃圾袋
  },
